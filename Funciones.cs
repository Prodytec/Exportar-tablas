    ...
    public class Funciones
    {
      ...
      //      string store;
       ...
       public void ControlPrecioMinimo(DataGridView datagrid, string store)
        ...
        public void HistoricoDolar(DataGridView datagrid, string store)   //Veneta
        {
            //llamo al store                                  
            SqlConnection cnn = DbConnection.getDBConnection();
            SqlDataAdapter da = new SqlDataAdapter(store, cnn);
        ...
        public void SaldoDolarUltimoMov(DataGridView datagrid, string store)   //Moutex, dolar del ultimoMov
        {
            //llamo al store                                  
            SqlConnection cnn = DbConnection.getDBConnection();
            SqlDataAdapter da = new SqlDataAdapter(store, cnn);
